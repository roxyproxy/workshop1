...
var (
	peerAddr = flag.String("peer", "localhost:8004", "peer host:port")
	self     string
)
...
func dial(addr string) {
	...
	err = proceedMessage(os.Stdin, c, self)
	if err != nil {
		log.Fatal(err)
	}
...
func proceedMessage(r io.Reader, w io.Writer, selfAddr string) (err error) {
